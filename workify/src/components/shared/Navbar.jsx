        ...
        <div className="bg-gray-900">
            <div className="flex items-center justify-between mx-auto max-w-7xl h-16">
                ...
                <div className="flex gap-5 items-center">
                    <img src={Logo} alt="User Icon" className="w-10 h-10 " />
                    ...
                    {/* Profile Popover */}
                    {
                        !user ? (
                            <div className="flex gap-2">
                                <Button
                                    variant="outline"
                                    className="text-black bg-white w-20 hover:bg-black hover:text-white"
                                >
                                    Login
                                </Button>
                                ...
                                <Button
                                    variant="outline"
                                    className="text-white bg-gray-900 w-20 hover:bg-white hover:text-black"
                                >
                                    Signup
                                </Button>
                            </div>
